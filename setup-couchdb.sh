...
echo ""
echo "  提示：如果配合一键 IP 证书脚本使用了反向代理 + HTTPS，"
echo -e "  服务器地址可填: ${GREEN}${BOLD}https://${SERVER_ADDR}/couchdb/${NC}"
echo "  手机端同步必须使用 https:// 开头的地址"
echo "  项目地址: https://github.com/ZO00OEY/ip-ssl-proxy"
echo ""
echo "  Web 管理后台: http://${SERVER_ADDR}:5984/_utils"
echo "  内部配置（一般用不上）: Erlang Cookie = ${COUCHDB_COOKIE}"
echo ""
